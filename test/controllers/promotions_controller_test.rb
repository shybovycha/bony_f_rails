...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { description: @promotion.description, ends_at: @promotion.ends_at, starts_at: @promotion.starts_at }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { description: @promotion.description, ends_at: @promotion.ends_at, starts_at: @promotion.starts_at }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
